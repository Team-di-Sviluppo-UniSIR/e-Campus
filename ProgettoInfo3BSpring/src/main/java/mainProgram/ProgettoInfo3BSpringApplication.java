...
public class ProgettoInfo3BSpringApplication {
	...
	public static void main(String[] args) {
		...
		Dish piatto1 = new Dish(0, "kiwi", null, 0, 0, 0, menu1);
		...
		Dish piatto12 = new Dish(6, "Pasta allo scoglio", "primo", 6, 100, 120, menu2);
		System.out.println("Campo inserito? " + canteenInput.insertNewDish(piatto12, menu2, m1in, da, ap));
		Dish piatto13 = new Dish(7, "Pollo al forno", "secondo", 4, 200, 150, menu2);
		System.out.println("Campo inserito? " + canteenInput.insertNewDish(piatto13, menu2, m1in, da, ap));
		Dish piatto14 = new Dish(8, "Merluzzo all'acquapazza", "secondo", 4.5, 150, 90, menu2);
		System.out.println("Campo inserito? " + canteenInput.insertNewDish(piatto14, menu2, m1in, da, ap));
		
		Dish piatto15 = new Dish(1, "Risotto alla milanese", "primo", 3, 230, 170, menu3);
		System.out.println("Campo inserito? " + canteenInput.insertNewDish(piatto15, menu3, m1in, da1, ap1));
		Dish piatto16 = new Dish(2, "Hamburger", "secondo", 4.5, 150, 90, menu2);
		System.out.println("Campo inserito? " + canteenInput.insertNewDish(piatto16, menu3, m1in, da1, ap1));
		...
		//PROVA UPDATE PORZIONI DISPONIBILI
		System.out.println("Campo modificato? " + canteenUpdate.updateAvailablePortions(100, piatto16, menu3, m1in, da1, ap1));
		System.out.println("Campo modificato? " + canteenUpdate.updateAvailablePortions(100, piatto13, menu2, m1in, da, ap));
		System.out.println("Campo modificato? " + canteenUpdate.updateAvailablePortions(50, piatto1, menu1, m1, d1, a1));
