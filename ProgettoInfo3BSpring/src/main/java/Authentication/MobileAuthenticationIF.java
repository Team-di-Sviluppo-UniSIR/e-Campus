...
public interface MobileAuthenticationIF {
	 ...
	 * @return true se il login è stato eseguito correttamente, false in caso contrario
	 */
	 ...
	 * @param user l'username inserito dall'utente
	 * @param password la password inserita dall'utente
	 * @return true se il logout è stato eseguito correttamente, false in caso contrario
	 */
